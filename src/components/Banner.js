...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "React.js", "Next.js", "Cloud" ];
  const period = 50;
      ...
      <Container>
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={5}>
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__zoomIn banner-animated-img" : ""}>
